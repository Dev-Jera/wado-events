...
@section('content')
    ...
    <style>
        .pm-admin-page { min-height: 100vh; background: #fdf8f8; padding: 8rem 1rem 3rem; }
        ...
        .pm-head h1 { margin: .3rem 0 0; color: #2a0c10; }
        .pm-head a { color: #c0283c; font-weight: 700; text-decoration: none; }
        .pm-filters { display: grid; grid-template-columns: 1fr 180px auto; gap: .6rem; margin-bottom: .8rem; }
        .pm-filters input, .pm-filters select { height: 42px; border: 1px solid #e8c8cc; border-radius: 10px; padding: 0 .75rem; }
        .pm-filters button { height: 42px; border: 0; border-radius: 10px; background: #c0283c; color: #fff; font-weight: 700; padding: 0 .9rem; }
        .pm-stats { display: grid; grid-template-columns: repeat(5, 1fr); gap: .55rem; margin-bottom: .75rem; }
        .pm-stat { background: #fff; border: 1px solid #e8c8cc; border-radius: 12px; padding: .65rem .7rem; display: grid; gap: .2rem; }
        .pm-stat strong { font-size: .7rem; color: #000000; }
        .pm-stat span { font-size: 1.2rem; font-weight: 800; color: #2a0c10; }
        .pm-table-wrap { overflow: auto; background: #fff; border: 1px solid #e8c8cc; border-radius: 14px; }
        .pm-table { width: 100%; border-collapse: collapse; min-width: 1120px; }
        .pm-table th, .pm-table td { border-bottom: 1px solid #f0dde0; padding: .6rem .65rem; text-align: left; font-size: .76rem; color: #2a1015; vertical-align: top; }
        .pm-table th { background: #fdf5f5; color: #7a4050; font-size: .66rem; letter-spacing: .09em; text-transform: uppercase; }
        .pm-badge { border-radius: 999px; padding: .2rem .48rem; font-size: .62rem; font-weight: 700; border: 1px solid; display: inline-flex; }
        .pm-badge.initiated, .pm-badge.pending { background: #fff6eb; border-color: #ffd7a8; color: #93540d; }
        ...
        .pm-table button { border: 0; border-radius: 8px; background: #c0283c; color: #fff; font-size: .68rem; padding: .36rem .62rem; font-weight: 700; cursor: pointer; }

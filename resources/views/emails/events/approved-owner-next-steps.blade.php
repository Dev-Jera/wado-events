...
<style>
    body { margin:0; padding:0; background:#edf1f8; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif; color:#0f172a; }
    .wrap { max-width:620px; margin:28px auto; background:#fff; border-radius:16px; overflow:hidden; box-shadow:0 8px 26px rgba(15,23,42,.12); }
    .header { padding:34px 36px 28px; background:linear-gradient(135deg,#0f766e 0%,#0f5f77 55%,#115e59 100%); color:#fff; }
    ...
    .status { display:inline-block; margin-top:14px; background:#d1fae5; color:#065f46; font-size:.72rem; font-weight:700; letter-spacing:.08em; text-transform:uppercase; border-radius:999px; padding:6px 12px; }
    .body { padding:30px 36px 18px; }
    .greeting { margin:0 0 12px; font-size:1.02rem; color:#111827; }
    .intro { margin:0 0 20px; font-size:.95rem; line-height:1.7; color:#334155; }
    .event-card { background:#f8fafc; border:1px solid #dce6f3; border-radius:12px; padding:18px 20px 14px; margin:0 0 20px; }
    .event-title { margin:0 0 12px; font-size:1.16rem; font-weight:800; color:#0f172a; }
    .row { display:flex; justify-content:space-between; gap:14px; border-bottom:1px dashed #d6deea; padding:8px 0; }
    .row:last-child { border-bottom:none; }
    .label { font-size:.75rem; text-transform:uppercase; letter-spacing:.06em; font-weight:700; color:#64748b; }
    .value { font-size:.9rem; color:#1f2937; text-align:right; }
    .notice { background:#ecfeff; border:1px solid #a5f3fc; border-radius:12px; padding:14px 16px; margin:0 0 20px; }
    .notice p { margin:0; color:#155e75; font-size:.9rem; line-height:1.65; }
    .section-title { margin:0 0 10px; font-size:.78rem; text-transform:uppercase; letter-spacing:.08em; color:#94a3b8; }
    .steps { margin:0 0 20px; }
    .step { display:flex; gap:12px; margin:0 0 10px; }
    .step-num { width:24px; height:24px; flex-shrink:0; border-radius:50%; background:#0f766e; color:#fff; font-size:.75rem; font-weight:700; display:flex; align-items:center; justify-content:center; }
    .step-text { padding-top:2px; font-size:.89rem; line-height:1.58; color:#334155; }
    .panel-card { background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px; padding:16px; margin:0 0 20px; }
    .panel-card p { margin:0 0 8px; font-size:.9rem; color:#334155; line-height:1.6; }
    .meta { margin:0; font-size:.87rem; color:#475569; }
    ...
    .btn-primary { background:#0f766e; color:#fff !important; }
    .btn-secondary { margin-left:8px; background:#e2e8f0; color:#0f172a !important; }
    .footer { background:#f8fafc; border-top:1px solid #e2e8f0; padding:16px 36px 22px; }

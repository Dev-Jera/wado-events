...
@section('content')
    ...
    <style>
        ...
        .auth-card h1 { margin: 0; color: #232645; font-size: clamp(1.55rem, 2.2vw, 1.85rem); line-height: 1.08; font-weight: 800; text-align: center; }
        ...
        .auth-form input[type="email"], .auth-form input[type="password"] { width: 100%; height: 42px; border: 1px solid #d7e0ef; border-radius: 8px; background: #fff; color: #23324a; padding: 0 0.8rem; font-size: 0.9rem; }
        ...
        .auth-check-box { height: 42px; border-radius: 8px; border: 1px solid #d7e0ef; background: #fff; display: flex; align-items: center; justify-content: center; }
        .auth-check-box input { width: 18px; height: 18px; }
        ...
        .auth-art-alert-input { border: 1px solid #f1a5af; border-radius: 8px; min-height: 36px; display: flex; align-items: center; padding: 0 0.6rem; color: #4b5267; font-size: 0.85rem; letter-spacing: 0.04em; }

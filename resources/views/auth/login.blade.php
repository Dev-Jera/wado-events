...
@section('content')
                ...
                <div class="auth-card-panel">
                    ...
                    <form method="POST" action="{{ route('login.store') }}" class="auth-form">
                        ...
                        <label>
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="email" inputmode="email" spellcheck="false" autocapitalize="none">
    ...
    <style>
        ...
        .auth-social-icon { width: 24px; height: 24px; display: inline-flex; align-items: center; justify-content: center; flex-shrink: 0; }
        .auth-social-btn img { width: 24px; height: 24px; object-fit: contain; border-radius: 4px; }

...
@section('content')
    ...
    <style>
        ...
        .auth-card { background: #0a1525; padding: 2rem 0.6rem 2rem 0; display: flex; align-items: center; justify-content: flex-start; }
        ...
        .auth-form input[type="email"] { width: 100%; height: 42px; border: 1px solid #1e3050; border-radius: 8px; background: #0d1929; color: #fff; padding: 0 0.8rem; font-size: 0.9rem; transition: border-color 0.15s, box-shadow 0.15s; }
